...
class ExampleScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("dreyr-idle", "images/Dreyr_idle_strip.png", {
      frameWidth: 128,
      frameHeight: 96,
    });
    this.load.spritesheet("dreyr-run", "images/Dreyr_run_strip.png", {
      frameWidth: 128,
      frameHeight: 96,
    });
  ...
  create() {
    ...
    this.logo = this.add
      .image(firstPosition[0], firstPosition[1], "logo")
      .setName("logo");
    ...
    const dreyr = this.add.sprite(250, 400);
    dreyr.setScale(10);
  ...
  getLogoPosition() {
    return [
      this.cameras.main.centerX + 300 * Math.sin(this.time.now / 317),
      this.cameras.main.centerY + 200 * Math.cos(this.time.now / 359),
    ];
  }
}
